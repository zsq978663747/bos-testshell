...
echo -e "\n\n"
echo "************************************************"
echo "*** test case 2: testerzsq111:transfer       ***"
echo "*** test case quantity: 7                    ***"
echo "************************************************"

sleep 8
echo -e "\n+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
echo -e "| testerzsq111 | transfer   |  should see message on the server   |"
echo -e "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
cleos transfer testerzsq111 testerecieve "10.0000 SYS"
...
sleep 8
echo -e "\n+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
echo -e "| testerzsq111 | revice token |should see message on the server   |"
echo -e "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
cleos transfer testerecieve testerzsq111 "10.0000 SYS"

sleep 8
echo -e "\n+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
echo -e "| testalaction | delegatebw testerzsq111 |  should see message on the server  |"
echo -e "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
cleos system delegatebw testerzsq111 testerzsq111 "10.0000 SYS" "10.0000 SYS"
sleep 8
echo -e "\n+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
echo -e "| testalaction | delegatebw testalaction |  should see message on the server  |"
echo -e "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
cleos system delegatebw testerzsq111 testerecieve "10.0000 SYS" "10.0000 SYS"

sleep 8
echo -e "\n--------------------------------------------------------------------------------"
echo -e "| testerzsq111 | undelegatebw testerzsq111 | shouldn't see message on the server  |"
echo -e "---------------------------------------------------------------------------------\n"
cleos system undelegatebw testerzsq111 testerzsq111 "10.0000 SYS" "10.0000 SYS"

sleep 8
echo -e "\n----------------------------------------------------------------------------------"
echo -e "| testerzsq111 | undelegatebw testerecieve |  shouldn't see message on the server  |"
echo -e "------------------------------------------------------------------------------------\n"
cleos system undelegatebw testerzsq111 testerecieve "10.0000 SYS" "10.0000 SYS"

sleep 8 
echo -e "\n----------------------------------------------------------------------"
echo -e "| testerzsq111 | regproducer |  shouldn't see message on the server  |"
echo -e "----------------------------------------------------------------------\n"
cleos system regproducer  testerzsq111 ${pub_key} https://www.123.com 90
sleep 8
echo -e "\n----------------------------------------------------------------------"
echo -e "| testerzsq111 | unregprod   |  shouldn't see message on the server  |"
echo -e "----------------------------------------------------------------------\n"
cleos system unregprod  testerzsq111 

sleep 8 
echo -e "\n---------------------------------------------------------------------------"
echo -e "| testerzsq111 | voteproducer proxy | shouldn't see message on the server |"
echo -e "---------------------------------------------------------------------------n"
cleos system voteproducer proxy testerzsq111  testerproxys
sleep 8
echo -e "\n---------------------------------------------------------------------------"
echo -e "| testerzsq111 | voteproducer prods | shouldn't see message on the server |"
echo -e "---------------------------------------------------------------------------"
cleos system voteproducer prods  testerzsq111 testproducer
sleep 8
echo -e "\n-----------------------------------------------------------------------------"
echo -e "| testerzsq111 | voteproducer approve | shouldn't see message on the server |"
echo -e "-----------------------------------------------------------------------------"
cleos system voteproducer approve  testerzsq111  testproduces
sleep 8
echo -e "\n-------------------------------------------------------------------------------"
echo -e "| testerzsq111 | voteproducer unapprove | shouldn't see message on the server |"
echo -e "-------------------------------------------------------------------------------"
cleos system voteproducer unapprove  testerzsq111   testproducer

sleep 8
echo -e "\n++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
echo -e "| testerzsq111 | buyram for self   |  should see message on the server |"
echo -e "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
cleos system buyram testerzsq111 testerzsq111 "5.0000 SYS"
sleep 8
echo -e "\n+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
echo -e "| testerzsq111 | sellram    |  should see message on the server |"
echo -e "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
cleos system sellram testerzsq111 100

sleep 8
echo -e "\n-----------------------------------------------------------------"
echo -e "| testerzsq111 | regproxy | shouldn't see message on the server |"
echo -e "-----------------------------------------------------------------\n"
cleos system regproxy testerzsq111
sleep 8
echo -e "\n-------------------------------------------------------------------"
echo -e "| testerzsq111 | unregproxy | shouldn't see message on the server |"
echo -e "-------------------------------------------------------------------\n"
cleos system unregproxy testerzsq111



echo "==========================================test case end=============================================\n"
echo "=======         we should see [ 7 ]   messages  from the server                     ===================\n"
