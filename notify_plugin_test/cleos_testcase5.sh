...
echo -e "\n\n"
echo "************************************************"
echo "*** test case 5: testerzsq114:regproducer    ***"
echo "*** test case 5: testerzsq114:unregprod      ***"
echo "*** test case quantity: 2                    ***"
echo "************************************************"

sleep 8
echo -e "\n-------------------------------------------------------------------"
echo -e "| testerzsq114 | transfer |  shouldn't see message on the server  |"
echo -e "-------------------------------------------------------------------\n"
cleos transfer testerzsq114 testerecieve "10.0000 SYS"

sleep 8
echo -e "\n----------------------------------------------------------------------"
echo -e "| testerzsq114 | recieve token | shouldn't see message on the server  |"
echo -e "----------------------------------------------------------------------\n"
cleos transfer testerecieve testerzsq114 "10.0000 SYS"

sleep 8
echo -e "\n----------------------------------------------------------------------"
echo -e "| testerzsq114 | delegatebw |  shouldn't see message on the server  |"
echo -e "----------------------------------------------------------------------\n"
cleos system delegatebw testerzsq114 testerzsq114 "10.0000 SYS" "10.0000 SYS"
sleep 8
echo -e "\n----------------------------------------------------------------------"
echo -e "| testerzsq114 | delegatebw |  shouldn't see message on the server  |"
echo -e "----------------------------------------------------------------------\n"
cleos system delegatebw testerzsq114 testerecieve "10.0000 SYS" "10.0000 SYS"

sleep 8
echo -e "\n-------------------------------------------------------------------------------"
echo -e "| testerzsq114 | undelegatebw testerzsq114 | shouldn't see message on the server  |"
echo -e "---------------------------------------------------------------------------------\n"
cleos system undelegatebw testerzsq114 testerzsq114 "10.0000 SYS" "10.0000 SYS"

sleep 8
echo -e "\n-------------------------------------------------------------------------------"
echo -e "| testerzsq114 | undelegatebw testerecieve | shouldn't see message on the server  |"
echo -e "---------------------------------------------------------------------------------\n"
cleos system undelegatebw testerzsq114 testerecieve "10.0000 SYS" "10.0000 SYS"

sleep 8 
echo -e "\n+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
echo -e "| testerzsq114 | regproducer |  should see message on the server  |"
echo -e "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n"
cleos system regproducer  testerzsq114 ${pub_key} https://www.123.com 90
sleep 8
echo -e "\n+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
echo -e "| testerzsq114 | unregprod   |  should see message on the server  |"
echo -e "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n"
cleos system unregprod  testerzsq114 

sleep 8 
echo -e "\n----------------------------------------------------------------------------"
echo -e "| testerzsq114 | voteproducer proxy |  shouldn't see message on the server |"
echo -e "----------------------------------------------------------------------------\n"
cleos system voteproducer proxy testerzsq114  testerproxys
sleep 8
echo -e "\n----------------------------------------------------------------------------"
echo -e "| testerzsq114 | voteproducer prods |  shouldn't see message on the server |"
echo -e "----------------------------------------------------------------------------\n"
cleos system voteproducer prods  testerzsq114 testproducer
sleep 8
echo -e "\n------------------------------------------------------------------------------"
echo -e "| testerzsq114 | voteproducer approve |  shouldn't see message on the server |"
echo -e "------------------------------------------------------------------------------\n"
cleos system voteproducer approve  testerzsq114  testproduces
sleep 8
echo -e "\n--------------------------------------------------------------------------------"
echo -e "| testerzsq114 | voteproducer unapprove |  shouldn't see message on the server |"
echo -e "--------------------------------------------------------------------------------\n"
cleos system voteproducer unapprove  testerzsq114   testproducer

sleep 8
echo -e "\n--------------------------------------------------------------------"
echo -e "| testerzsq114 | buyram    |  shouldn't see message on the server  |"
echo -e "--------------------------------------------------------------------\n"
cleos system buyram testerzsq114 testerzsq114 "5.0000 SYS"
sleep 8
echo -e "\n--------------------------------------------------------------------"
echo -e "| testerzsq114 | sellram   |  shouldn't see message on the server  |"
echo -e "--------------------------------------------------------------------\n"
cleos system sellram testerzsq114 100

sleep 8
echo -e "\n-------------------------------------------------------------------"
echo -e "| testerzsq114 | regproxy |  shouldn't see message on the server  |"
echo -e "-------------------------------------------------------------------\n"
cleos system regproxy testerzsq114

sleep 8
echo -e "\n----------------------------------------------------------------------"
echo -e "| testerzsq114 | unregproxy |  shouldn't see message on the server  |"
echo -e "----------------------------------------------------------------------\n"
cleos system unregproxy testerzsq114
...
echo "==========================================test case end=============================================\n"
echo "=======         we should see [ 2 ]   messages  from the server                     ===================\n"
